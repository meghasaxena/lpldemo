...
public class Home {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//div/span[text()='Home']")).click();//click on the home tab
		Thread.sleep(3000);
		...
		//Thread.sleep(3000);
		driver.findElement(By.xpath("//tbody/tr[1]/td[@role='gridcell']/a/span")).click();
		//td[@role='gridcell']/a/span[text()='STF2 STL2']
		//click on the student under home
		
		//WebElement form=driver.findElement(By.id("myform"));
		//driver.switchTo().frame(form);
		
		//List<WebElement> aa=driver.findElements(By.xpath("//div[@id='rigt1']/div/span"));
		try{
			List<WebElement> aa= driver.findElements(By.xpath("//div[@class='homestu-details']/div/span[1]"));
			//List<WebElement> aa=driver.findElements(By.tagName("span"));
			int bb= aa.size();
		...
		//on pop-up notes text as a teacher
		...
		*/
		...
		String hh3=driver.getCurrentUrl();
		System.out.println(hh3);
		//driver.wait();
		Class<? extends WebDriver> hh2= driver.getClass();
		System.out.println(hh2);
		String hh1=driver.getPageSource();
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//div[@id='mybookshelf']/span")).click();// click on the search and assign
		Thread.sleep(3000);
